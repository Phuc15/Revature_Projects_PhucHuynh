...
/**
 * BankSystemController is used to communicate between the front end and backend using Javalin
 *
 * @return a string
 */
public class BankSystemController {
    private static Logger logger = Logger.getLogger(BankSystemController.class);

    public void bankSystemController(){
